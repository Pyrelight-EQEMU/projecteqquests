...
function event_trade(e)
	...
	if(e.other:GetClass() == Class.MAGICIAN and item_lib.check_turn_in(e.trade, {item1 = 28032, item2 = 28009, item3 = 28006, item4 = 28033})) then
		...
		e.other:SummonItem(28034); -- Item: Orb of Mastery
		eq.depop();
		eq.stop_timer("depop");
	end
