...
my $explain_message = "Little white dragon! Just kidding! Not little! Kill Lady Vox, and her goblin minions!";
my @target_list     = (73057,73103,73058,73006); # Array of npc_type IDs that we need to kill. Add multiple times for quantity.
my $target_level    = 52;
