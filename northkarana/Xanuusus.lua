...
function event_trade(e)
  ...
  if ( e.other:Class() == "Ranger" and qglobals["ranger_epic15_pre"] ~= nil) then
	...
	if(e.other:GetClass() == Class.RANGER and item_lib.check_turn_in(e.trade, {item1 = 20483,item2 = 20484})) then
	...
	elseif(e.other:GetClass() == Class.DRUID and item_lib.check_turn_in(e.trade, {item1 = 20699,item2 = 20697,item3 = 20698,item4 = 20440})) then
